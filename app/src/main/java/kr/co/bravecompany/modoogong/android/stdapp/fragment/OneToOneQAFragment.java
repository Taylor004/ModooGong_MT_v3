...
public class OneToOneQAFragment extends BaseFragment {
    ...
    public static OneToOneQAFragment newInstance() {
        return new OneToOneQAFragment();
    }
    ...
    protected void initLayout(LayoutInflater inflater, ViewGroup rootView) {
        ...
        mPagerAdapter = new OneToOneQAPagerAdapter(getChildFragmentManager());
