...
public class AnimatedExpandableListView extends ExpandableListView {
     ...
     * instance for group expansion, we tell the subjectNameAdapter to animate the
     ...
     * ExpandableListView does this is by calling getView() in the subjectNameAdapter.
     * However since the subjectNameAdapter knows that we are animating a certain group,
     ...
     * subjectNameAdapter to stop animating the group and call notifyDataSetChanged. Now
     ...
     *
     * 1. The ExpandableListView tells the subjectNameAdapter to animate a certain group.
     ...
     * 5. Since the subjectNameAdapter is in "animating mode", it will return a dummy view.
     ...
     * 8. Once the animation completes, the subjectNameAdapter is notified to stop
     ...
     * 4. Since the subjectNameAdapter is in "animating mode", it will return a dummy view.
     ...
     * 7. Once the animation completes, the subjectNameAdapter is notified to stop
     *    animating the group and notifyDataSetChanged is called again.
    ...
    public void setAdapter(ExpandableListAdapter adapter) {
        ...
        // Make sure that the subjectNameAdapter extends AnimatedExpandableListAdapter
    ...
    public boolean expandGroupWithAnimation(int groupPos) {
    	//boolean lastGroup = groupPos == subjectNameAdapter.getGroupCount() - 1;
        ...
        if (groupFlatPos != -1) {
            ...
            if (childIndex < getChildCount()) {
                ...
                if (v.getBottom() >= getBottom()) {
                    ...
                    // We need to notify the subjectNameAdapter that the group was expanded
        ...
        // Let the subjectNameAdapter know that we are starting the animation...
    ...
    public boolean collapseGroupWithAnimation(int groupPos) {
        ...
        // Let the subjectNameAdapter know that we are going to start animating the
        // collapse animation.
    ...
    /**
     * A specialized subjectNameAdapter for use with the AnimatedExpandableListView. All
